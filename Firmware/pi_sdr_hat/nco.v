...
/* Module Version: 1.6 */
/* /usr/local/diamond/3.13/ispfpga/bin/lin64/scuba -w -n nco -lang verilog -synth lse -bus_exp 7 -bb -arch xo2c00 -type cosine -addr_width 8 -width 10 -pfu -mode 2 -output_reg -area -pipeline 1  */
/* Thu Sep 26 22:29:12 2024 */


`timescale 1 ns / 1 ps
module nco (Clock, ClkEn, Reset, Theta, Sine, Cosine)/* synthesis NGD_DRC_MASK=1 */;
    input wire Clock;
    input wire ClkEn;
    input wire Reset;
    ...
    INV INV_27 (.A(Theta[5]), .Z(Theta_5_inv));

    INV INV_26 (.A(Theta[4]), .Z(Theta_4_inv));

    INV INV_25 (.A(Theta[3]), .Z(Theta_3_inv));

    INV INV_24 (.A(Theta[2]), .Z(Theta_2_inv));

    INV INV_23 (.A(Theta[1]), .Z(Theta_1_inv));

    INV INV_22 (.A(Theta[0]), .Z(Theta_0_inv));

    XOR2 XOR2_t1 (.A(Theta[6]), .B(Theta[7]), .Z(cosromoutsel_i));
    ...
    ROM16X1A LUT4_1 (.AD3(rom_addr0), .AD2(rom_addr0_1), .AD1(rom_addr0_2), 
        .AD0(rom_addr0_3), .DO0(func_or_inet));

    defparam LUT4_0.initval =  16'hfffe ;
    ROM16X1A LUT4_0 (.AD3(func_or_inet), .AD2(rom_addr0_4), .AD1(rom_addr0_5), 
        .AD0(scuba_vlo), .DO0(lx_ne0));

    INV INV_1 (.A(lx_ne0), .Z(lx_ne0_inv));

    AND2 AND2_t0 (.A(Theta[6]), .B(lx_ne0_inv), .Z(out_sel_i));

    INV INV_0 (.A(Theta[7]), .Z(Theta_7_inv));

    MUX21 muxb_45 (.D0(Theta[0]), .D1(rom_addr0_n), .SD(Theta[6]), .Z(rom_addr0));

    MUX21 muxb_44 (.D0(Theta[1]), .D1(rom_addr0_n_1), .SD(Theta[6]), .Z(rom_addr0_1));

    MUX21 muxb_43 (.D0(Theta[2]), .D1(rom_addr0_n_2), .SD(Theta[6]), .Z(rom_addr0_2));

    MUX21 muxb_42 (.D0(Theta[3]), .D1(rom_addr0_n_3), .SD(Theta[6]), .Z(rom_addr0_3));

    MUX21 muxb_41 (.D0(Theta[4]), .D1(rom_addr0_n_4), .SD(Theta[6]), .Z(rom_addr0_4));

    MUX21 muxb_40 (.D0(Theta[5]), .D1(rom_addr0_n_5), .SD(Theta[6]), .Z(rom_addr0_5));
    ...
    FD1P3DX FF_21 (.D(Theta[7]), .SP(ClkEn), .CK(Clock), .CD(Reset), .Q(sinromoutsel))
             /* synthesis GSR="ENABLED" */;
    ...
    MUX21 muxb_10 (.D0(rom_dout_s_9), .D1(Theta[7]), .SD(out_sel), .Z(sinout_pre_9));
    ...
    FADD2B neg_rom_addr0_n_0 (.A0(scuba_vlo), .A1(Theta_0_inv), .B0(scuba_vlo), 
        .B1(scuba_vhi), .CI(scuba_vlo), .COUT(co0), .S0(), .S1(rom_addr0_n));

    FADD2B neg_rom_addr0_n_1 (.A0(Theta_1_inv), .A1(Theta_2_inv), .B0(scuba_vlo), 
        .B1(scuba_vlo), .CI(co0), .COUT(co1), .S0(rom_addr0_n_1), .S1(rom_addr0_n_2));

    FADD2B neg_rom_addr0_n_2 (.A0(Theta_3_inv), .A1(Theta_4_inv), .B0(scuba_vlo), 
        .B1(scuba_vlo), .CI(co1), .COUT(co2), .S0(rom_addr0_n_3), .S1(rom_addr0_n_4));

    FADD2B neg_rom_addr0_n_3 (.A0(Theta_5_inv), .A1(scuba_vlo), .B0(scuba_vlo), 
        .B1(scuba_vlo), .CI(co2), .COUT(), .S0(rom_addr0_n_5), .S1());

    defparam triglut_1_0_19.initval =  64'h0000000000000000 ;
    ROM64X1A triglut_1_0_19 (.AD5(rom_addr0_5), .AD4(rom_addr0_4), .AD3(rom_addr0_3), 
        .AD2(rom_addr0_2), .AD1(rom_addr0_1), .AD0(rom_addr0), .DO0(rom_dout_9_ffin));

    defparam triglut_1_0_18.initval =  64'hC000000000000000 ;
    ROM64X1A triglut_1_0_18 (.AD5(rom_addr0_5), .AD4(rom_addr0_4), .AD3(rom_addr0_3), 
        .AD2(rom_addr0_2), .AD1(rom_addr0_1), .AD0(rom_addr0), .DO0(rom_dout_8_ffin));

    defparam triglut_1_0_17.initval =  64'h3FFFFFFFFFC00000 ;
    ROM64X1A triglut_1_0_17 (.AD5(rom_addr0_5), .AD4(rom_addr0_4), .AD3(rom_addr0_3), 
        .AD2(rom_addr0_2), .AD1(rom_addr0_1), .AD0(rom_addr0), .DO0(rom_dout_7_ffin));

    defparam triglut_1_0_16.initval =  64'h3FFFFFF8003FF800 ;
    ROM64X1A triglut_1_0_16 (.AD5(rom_addr0_5), .AD4(rom_addr0_4), .AD3(rom_addr0_3), 
        .AD2(rom_addr0_2), .AD1(rom_addr0_1), .AD0(rom_addr0), .DO0(rom_dout_6_ffin));

    defparam triglut_1_0_15.initval =  64'h3FFFF007F03F07C0 ;
    ROM64X1A triglut_1_0_15 (.AD5(rom_addr0_5), .AD4(rom_addr0_4), .AD3(rom_addr0_3), 
        .AD2(rom_addr0_2), .AD1(rom_addr0_1), .AD0(rom_addr0), .DO0(rom_dout_5_ffin));

    defparam triglut_1_0_14.initval =  64'h3FFC0F878E38E738 ;
    ROM64X1A triglut_1_0_14 (.AD5(rom_addr0_5), .AD4(rom_addr0_4), .AD3(rom_addr0_3), 
        .AD2(rom_addr0_2), .AD1(rom_addr0_1), .AD0(rom_addr0), .DO0(rom_dout_4_ffin));

    defparam triglut_1_0_13.initval =  64'h3FC38E664DB696B4 ;
    ROM64X1A triglut_1_0_13 (.AD5(rom_addr0_5), .AD4(rom_addr0_4), .AD3(rom_addr0_3), 
        .AD2(rom_addr0_2), .AD1(rom_addr0_1), .AD0(rom_addr0), .DO0(rom_dout_3_ffin));

    defparam triglut_1_0_12.initval =  64'h3E336D556964CCE6 ;
    ROM64X1A triglut_1_0_12 (.AD5(rom_addr0_5), .AD4(rom_addr0_4), .AD3(rom_addr0_3), 
        .AD2(rom_addr0_2), .AD1(rom_addr0_1), .AD0(rom_addr0), .DO0(rom_dout_2_ffin));

    defparam triglut_1_0_11.initval =  64'h39AAD87C3329556A ;
    ROM64X1A triglut_1_0_11 (.AD5(rom_addr0_5), .AD4(rom_addr0_4), .AD3(rom_addr0_3), 
        .AD2(rom_addr0_2), .AD1(rom_addr0_1), .AD0(rom_addr0), .DO0(rom_dout_1_ffin));

    defparam triglut_1_0_10.initval =  64'h353F6983AA9C003C ;
    ROM64X1A triglut_1_0_10 (.AD5(rom_addr0_5), .AD4(rom_addr0_4), .AD3(rom_addr0_3), 
        .AD2(rom_addr0_2), .AD1(rom_addr0_1), .AD0(rom_addr0), .DO0(rom_dout_ffin));

    defparam triglut_1_0_9.initval =  64'h0000000000000000 ;
    ROM64X1A triglut_1_0_9 (.AD5(rom_addr0_5), .AD4(rom_addr0_4), .AD3(rom_addr0_3), 
        .AD2(rom_addr0_2), .AD1(rom_addr0_1), .AD0(rom_addr0), .DO0(rom_dout_19_ffin));

    defparam triglut_1_0_8.initval =  64'h0000000000000007 ;
    ROM64X1A triglut_1_0_8 (.AD5(rom_addr0_5), .AD4(rom_addr0_4), .AD3(rom_addr0_3), 
        .AD2(rom_addr0_2), .AD1(rom_addr0_1), .AD0(rom_addr0), .DO0(rom_dout_18_ffin));

    defparam triglut_1_0_7.initval =  64'h000007FFFFFFFFF8 ;
    ROM64X1A triglut_1_0_7 (.AD5(rom_addr0_5), .AD4(rom_addr0_4), .AD3(rom_addr0_3), 
        .AD2(rom_addr0_2), .AD1(rom_addr0_1), .AD0(rom_addr0), .DO0(rom_dout_17_ffin));

    defparam triglut_1_0_6.initval =  64'h003FF8003FFFFFF8 ;
    ROM64X1A triglut_1_0_6 (.AD5(rom_addr0_5), .AD4(rom_addr0_4), .AD3(rom_addr0_3), 
        .AD2(rom_addr0_2), .AD1(rom_addr0_1), .AD0(rom_addr0), .DO0(rom_dout_16_ffin));

    defparam triglut_1_0_5.initval =  64'h07C1F81FC01FFFF8 ;
    ROM64X1A triglut_1_0_5 (.AD5(rom_addr0_5), .AD4(rom_addr0_4), .AD3(rom_addr0_3), 
        .AD2(rom_addr0_2), .AD1(rom_addr0_1), .AD0(rom_addr0), .DO0(rom_dout_15_ffin));

    defparam triglut_1_0_4.initval =  64'h39CE38E3C3E07FF8 ;
    ROM64X1A triglut_1_0_4 (.AD5(rom_addr0_5), .AD4(rom_addr0_4), .AD3(rom_addr0_3), 
        .AD2(rom_addr0_2), .AD1(rom_addr0_1), .AD0(rom_addr0), .DO0(rom_dout_14_ffin));

    defparam triglut_1_0_3.initval =  64'h5AD2DB64CCE387F8 ;
    ROM64X1A triglut_1_0_3 (.AD5(rom_addr0_5), .AD4(rom_addr0_4), .AD3(rom_addr0_3), 
        .AD2(rom_addr0_2), .AD1(rom_addr0_1), .AD0(rom_addr0), .DO0(rom_dout_13_ffin));

    defparam triglut_1_0_2.initval =  64'hCE664D2D556D98F8 ;
    ROM64X1A triglut_1_0_2 (.AD5(rom_addr0_5), .AD4(rom_addr0_4), .AD3(rom_addr0_3), 
        .AD2(rom_addr0_2), .AD1(rom_addr0_1), .AD0(rom_addr0), .DO0(rom_dout_12_ffin));

    defparam triglut_1_0_1.initval =  64'hAD5529987C36AB38 ;
    ROM64X1A triglut_1_0_1 (.AD5(rom_addr0_5), .AD4(rom_addr0_4), .AD3(rom_addr0_3), 
        .AD2(rom_addr0_2), .AD1(rom_addr0_1), .AD0(rom_addr0), .DO0(rom_dout_11_ffin));

    defparam triglut_1_0_0.initval =  64'h780072AB832DF958 ;
    ROM64X1A triglut_1_0_0 (.AD5(rom_addr0_5), .AD4(rom_addr0_4), .AD3(rom_addr0_3), 
        .AD2(rom_addr0_2), .AD1(rom_addr0_1), .AD0(rom_addr0), .DO0(rom_dout_10_ffin));
